    ...
    <div class="container">
        <nav>
            <div class="navbar">
                ...
                <ul>
                    <li><a href="user_dashboard.php"><i class="fas fa fa-home"></i><span class="nav-item">Home</span></a></li>
                    ...
                    <li><a href="../admin/login.php"><i class="fas fa-sign-out-alt"></i><span class="nav-item">Logout</span></a></li>
                </ul>
            </div>
        </nav>
